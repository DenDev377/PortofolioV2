...
const journey = [
  {
    ...
    description: "Pertama kali terjun ke dunia pemrograman. Mempelajari logika dasar hingga struktur pengkondisian, dan mulai mengenal cara membuat halaman web statis riil.",
  ...
  },
  {
    ...
    description: "Meningkatkan kemampuan pemecahan masalah (logic) dan melangkah ke pembuatan aplikasi web modern menggunakan ekosistem JavaScript.",
  ...
  },
  {
    ...
    description: "Berfokus pada pengembangan backend modern, pemrograman berbasis objek yang lebih dalam, pola desain MVC (Model-View-Controller), serta API.",
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-5xl relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">
            Perjalanan <span className="text-primary text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500">Kode Saya</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Garis waktu bagaimana saya berkembang dari sekadar rasa penasaran dengan C++ hingga menguasai ekosistem Full-Stack modern di bangku kuliah.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="flex flex-col gap-12 mt-8">
            {journey.map((item, index) => {
              ...
              return (
                <div key={item.id} className={`relative flex items-center w-full ${isEven ? 'md:flex-row-reverse' : 'md:flex-row'} flex-row`}>
